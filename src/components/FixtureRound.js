  ...
  return (
    <div className="col justify-start items-center w-[600px] h-full overflow-y-scroll bg-slate-100 dark:bg-slate-800 dark:text-teal-200 rounded-lg border-2 border-slate-500">
      ...
      {matches.map((match, id) => (
        <div key={`round-fixture-${id}`} className="row justify-between items-center w-full p-1 odd:bg-blue-400/20 even:bg-green-400/20 hover:bg-yellow-300/20">
          <span className="w-[47%]">
