...
function totalScore({ goals = 0, behinds = 0 }) {
...
function MatchSummary({
  ...
  return (
    <div className="bg-blue-200 dark:bg-blue-800 dark:text-pink-300 p-2 w-full h-full overflow-y-scroll whitespace-nowrap col justify-start items-center min-w-[600px]">
